...
type AppDetailRailPreviewProps = {
...
function AppDetailRailPreview({
  type,
  title,
  footerAction,
  sections,
}: AppDetailRailPreviewProps) {
  return (
    <AppDetailRail
      header={
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <AppEyebrow className="text-[0.68rem]">{type} RESULT</AppEyebrow>
      ...
      footer={<AppButton className="w-full">{footerAction}</AppButton>}
    >
      <div className="grid gap-4">
        <AppDetailSection>
          ...
          <p className="text-sm leading-6 text-white/68">
            A precise editorial result with reusable lighting, composition, and
            camera direction.
          </p>
        </AppDetailSection>
        {sections > 1 ? (
...
const meta = {
  ...
  component: AppDetailRailPreview,
  args: {
    type: "image",
    title: "GPT Image 2",
    footerAction: "Recreate",
    sections: 2,
  },
  argTypes: {
    type: { control: "select", options: ["image", "video", "audio"] },
    title: { control: "text" },
    footerAction: { control: "text" },
    sections: { control: "select", options: [1, 2] },
  },
  decorators: [
    (Story) => (
...
} satisfies Meta<typeof AppDetailRailPreview>;
...
export const Playground: Story = {
  render: (args) => <AppDetailRailPreview {...args} />,
};
