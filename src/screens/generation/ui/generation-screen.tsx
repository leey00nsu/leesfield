"use client";
import styles from "./generation-screen.module.css";
import { BrandModelMarquee } from "@/shared/ui/brand-model-marquee";
...
export function GenerationScreen({
  ...
  return (
    <AppPageShell beforeIntro={<BrandModelMarquee />} ref={container} className={`${styles.shell} flex-1 justify-center py-8 sm:py-8`} intro={{ title: t("title"), description: t("description") }}>
      <TabsPrimitive.Root
