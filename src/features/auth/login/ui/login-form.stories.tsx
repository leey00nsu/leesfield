...
function LoginPanel() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#07090b] p-8 text-white">
      <section className="w-full max-w-[22.375rem] rounded-[2rem] border border-white/10 bg-card/95 p-8 shadow-[0_28px_130px_rgba(0,0,0,0.58)]">
        <div className="flex flex-col items-center text-center">
          <AppBrandLogo
            variant="icon"
            size="lg"
            className="mb-6"
            markClassName="shadow-[0_0_34px_rgba(52,127,244,0.25)]"
          />
